...
/// Clean, brand-neutral starting theme for new apps.
/// This is the default theme applied when you first clone the template.
///
/// Key customization points:
///   - Brand color: Change the `primary` color below (marked with "START HERE")
///   - Typography: Adjust sizes in the TypographyScale if needed
///   - Corner radius: Adjust RadiiScale values for your brand's roundedness preference
///
public struct CleanTheme: Theme, Sendable {
    public let tokens: DesignTokens

    public init() {
        let colors = ColorPalette(
            // ============================================================
            // START HERE: Change your brand color
            // Replace Color.indigo below with your app's primary brand color.
            // This controls buttons, links, active states, tab icons, and accents.
            // Example: Color(hex: "#FF5722") or Color.blue or Color(red: 0.2, green: 0.6, blue: 1.0)
            // ============================================================
            primary: Color.indigo,
            secondary: Color(light: Color(hex: "5856D6").opacity(0.7), dark: Color(hex: "7B79FF").opacity(0.8)),
            accent: Color.indigo,
